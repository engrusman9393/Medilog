...
<body>
    ...
    <div class="receipt-container">
        ...
        <div class="total-section">
            ...
            <div>
                <strong>Tax (<?php echo $receipt['tax_rate']; ?>%): $<?php echo number_format($receipt['tax_amount'], 2); ?></strong>
            </div>
            <div>
            ...
            <div>
                <strong>Paid: $<?php echo number_format($receipt['paid_amount'], 2); ?></strong>
            </div>
            <div>
                <strong>Change: $<?php echo number_format($receipt['paid_amount'] - $receipt['total_amount'], 2); ?></strong>
            </div>
        </div>
